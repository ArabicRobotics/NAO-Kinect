...
namespace KinectCatcher
{
    public class clsKinectArgs :EventArgs
    {
        ...
        private clsNeck _neck;
        private clsHead _head;
        public clsHead head { get { return _head; } set { _head = value; } }
        public clsNeck neck { get { return _neck; } set{ _neck = value; } }
        public clsWrist wrist{get{return _wrist;}set { _wrist = value; }}
